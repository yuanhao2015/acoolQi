    ...
    >
      ...
      <el-table-column label="操作类型" align="center" prop="businessType">
        <template slot-scope="scope">
          <el-tag :type="typeFormatcss(scope.row, scope.row.businessType)[1]">{{
            typeFormatcss(scope.row, scope.row.businessType)[0]
          }}</el-tag>
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    // 操作日志类型字典翻译
    typeFormatcss(row, column) {
      return this.selectDictLabelandcss(this.typeOptions, row.businessType);
    },
    /** 搜索按钮操作 */
    handleQuery() {
